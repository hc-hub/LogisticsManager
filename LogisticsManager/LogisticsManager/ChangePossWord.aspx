<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePossWord.aspx.cs" Inherits="LogisticsManager.ChangePossWord" %>
...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <i class="icon-question-sign icon-white"></i><a href="#">帮助</a> <i class="icon-off icon-white"></i><a id="modal-973558" href="#modal-container-973558" role="button" data-toggle="modal">注销</a> <i class="icon-user icon-white"></i><a href="ChangePossWord.aspx">修改密码</a> <i class="icon-envelope icon-white"></i><a href="#">发送短信</a>
                    ...
                    <div style="width: 900px; margin: auto;">
                        <table>
                            ...
                            <tr>
                                <td>确认新密码：</td>
                                <td>
                                    <asp:TextBox ID="txtNewConPwd" runat="server" TextMode="Password"></asp:TextBox></td> 
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <asp:Button ID="btnChangePwd" runat="server" Text="修改" CssClass="button orange" OnClick="btnChangePwd_Click" /></td>
