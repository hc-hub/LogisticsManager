<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateTruck.aspx.cs" Inherits="LogisticsManager.UpdateTruck" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>修改车辆信息</strong></div>
                    <div style="width: 900px; margin: auto;">                       
                        <table class="bordered">
                            <tr>
                                ...
                                <td>车队名称:</td>
                                <td>
                                    <asp:DropDownList ID="ddlTruck" runat="server" Height="29px"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>车辆类型:</td>
                                <td>
                                    <asp:DropDownList ID="ddlTruckType" runat="server" Height="29px"></asp:DropDownList></td>
                                <td>购车时间:</td>
                                <td>                                  
                            ...
                            <tr>
                                <td>工作状态</td>
                                <td>
                                    <asp:DropDownList ID="ddlTruckState" runat="server" CssClass="auto-style2" Height="29px"></asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td>备注:</td>
                                <td colspan="3">
                        ...
                        <tr>
                                ...
                                <td colspan="6" >
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnUpdat" runat="server" Text="修改" CssClass="button orange" OnClick="btnUpdat_Click" /></td>
                        ...
                        <tr>
                                <td colspan="6" align="center">
                                    ...
                                    <asp:Button ID="btnReset" runat="server" CssClass="button gray" Text="返回" OnClick="btnReset_Click" />
                                </td>
