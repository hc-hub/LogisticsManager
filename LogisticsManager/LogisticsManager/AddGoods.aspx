<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddGoods.aspx.cs" Inherits="LogisticsManager.AddGoods" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>添加货物</strong></div>
                    <div style="width: 900px; margin: auto;">
                        <table>
                            <tr>
                                <td>货物名称:</td>
                                <td>
                                    <asp:TextBox ID="txtGoodsName" runat="server"></asp:TextBox></td>
                                <td>数量:</td>
                                <td>
                           ...
                           <tr>        
                               <td></td>              
                                  ...
                                  <td>  <asp:Button ID="btnAdd" runat="server" Text="添加" CssClass=" button orange" OnClick="btnAdd_Click" />
                                </td>
                                <td>
                                   <asp:Button ID="btnReset" runat="server" Text="重置" CssClass="button orange" /> </td>
