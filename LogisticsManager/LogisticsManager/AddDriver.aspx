<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDriver.aspx.cs" Inherits="LogisticsManager.AddDriver" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>添加驾驶员信息</strong></div>
                    <div style="width: 900px; margin: auto;">
                        <table>
                            ...
                            <tr>
                                <td>性别:</td>
                                <td>
                                    <asp:RadioButtonList ID="rdlSex" runat="server" RepeatDirection="Horizontal" Width="48px">
                            ...
                            <tr>
                                <td>车队:</td>
                                <td style="float: left">
                                    <asp:DropDownList ID="ddlTruck" runat="server" Width="70px"></asp:DropDownList></td>
                            </tr>
                            <tr>
