<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUserInfo.aspx.cs" Inherits="LogisticsManager.AddUserInfo" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>添加用户信息</strong></div>
                    <div style="width: 900px; margin: auto;">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>是否激活：</td>
                                <td>
                                    <asp:RadioButtonList ID="rdlIsDelete" runat="server" RepeatDirection="Horizontal">
                            ...
                            <tr>
                                ...
                                <td>角色：</td>
                                <td>
                                    <asp:DropDownList ID="ddlRoleName" runat="server" Height="30px"></asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td>密码：</td>
                                <td>
                            ...
                            <tr>
                                <td>确认密码：</td>
                                <td>
                                    <asp:TextBox ID="txtConpwd" runat="server" TextMode="Password"></asp:TextBox></td>
                                <td>
    ...
    <!-- 底部 -->
    <div id="footer">版权所有：不简单客流 &copy; 2015&nbsp;&nbsp;&nbsp;&nbsp;服务热线：0371-88888888</div>
