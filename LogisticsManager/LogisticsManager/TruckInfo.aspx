<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TruckInfo.aspx.cs" Inherits="LogisticsManager.TruckInfo" %>
                    ...
                    <div style="width: 900px; margin: auto;">                       
                        <table>
                            <tr>
                                ...
                                <td>车队名称:</td>
                                <td>
                                    <asp:Label ID="lblTeamName" runat="server" Text="Label"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>车辆类型:</td>
                                ...
                                <td>购车时间:</td>
                                <td>                                  
                                    <asp:Label ID="lblBuyDate" runat="server" Text="Label"></asp:Label></td>

                            </tr>
                            <tr>
                                <td>车身长度(米):</td>
                                <td>
                                    <asp:Label ID="lblLength" runat="server" Text="Label"></asp:Label></td>
                                <td>车辆吨位(吨):</td>
                                <td>
                                    <asp:Label ID="lblTonnage" runat="server" Text="Label"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>工作状态</td>
                                <td>
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    <hr />
                                    <asp:LinkButton ID="lbtnReset" CssClass="button gray" runat="server">返回</asp:LinkButton>
                                </td>
