<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulingTruck.aspx.cs" Inherits="LogisticsManager.SchedulingTruck" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>当前可调度车辆</strong></div>
                    <div style="width: 900px; margin: auto;">
                        <table class="bordered">
                            ...
                            <tbody>
                                <asp:Repeater ID="rpt_Truck" runat="server" OnItemCommand="rpt_Truck_ItemCommand">
                                    <ItemTemplate>
                                    <tr>
                                        <td><%#Eval("Number") %></td>
                                        <td><%#Eval("Type") %></td>
                                        ...
                                        <td><%#Eval("Tonnage") %></td>
                                        <td>
                                            <asp:LinkButton ID="lbtnCommandTruck" CommandName="CommandTruck" CommandArgument='<%#Eval("TruckID") %>' CssClass="button orange" runat="server">调度</asp:LinkButton></td>
                                    </tr>
                                        </ItemTemplate>
                        ...
                        <tr>
                                <td colspan="6" align="center">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnResult" runat="server" CssClass="button orange" Text="返回" OnClick="btnResult_Click" />
                                </td>
