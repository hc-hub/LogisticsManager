<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DriverBindTruck.aspx.cs" Inherits="LogisticsManager.DriverBindTruck" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>驾驶员绑定车辆</strong></div>
                    <div style="width: 900px; margin: auto;">
                        为驾驶员<asp:Label ID="lblDriverName" CssClass="name" runat="server" Text=""></asp:Label>绑定所在车队当前空闲车辆
                                        ...
                                        <asp:Repeater ID="rpt_Truck" runat="server" OnItemCommand="rpt_Truck_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%#Eval("Tonnage") %></td>
                                                    <td>
                                                        <asp:LinkButton ID="LinkButton1" CommandName="BindTruck" CommandArgument='<%#Eval("TruckID") %>' OnClientClick='return confirm("您确定要绑定该车辆吗？")' CssClass="button orange" runat="server">绑定该车</asp:LinkButton></td>
                                                </tr>
                                            </ItemTemplate>
