<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTruckTeam.aspx.cs" Inherits="LogisticsManager.AddTruckTeam" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>添加车队信息</strong></div>
                    <div style="width: 900px; margin: auto;">
                        <table>
                            <tr>
                                <td>车队名称:</td>
                                <td>
                                    <asp:TextBox ID="txtTruckName" runat="server"></asp:TextBox></td>
                                <td>车队负责人:</td>
                                <td>
                            ...
                            <tr>
                                <td>备注</td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtRemark" runat="server" TextMode="MultiLine" Height="73px" Width="457px"></asp:TextBox></td>
                                
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <asp:Button ID="btnAdd" runat="server" Text="添加" CssClass="button orange" OnClick="btnAdd_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnReset" runat="server" Text="重置" CssClass="button orange" OnClick="btnReset_Click" /></td>
