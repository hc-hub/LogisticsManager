<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarriageTeam.aspx.cs" Inherits="LogisticsManager.CarriageTeam" %>
...
<ul class="breadcrumb">当前位置：
  ...
  查询承运车队
   ...
   <div class="title_right"><strong>查询承运车队</strong></div>  
<div style="width:900px;margin:auto;">
    <div>
        车队名称:<asp:DropDownList ID="ddlTruck" runat="server" Height="25px" Width="71px"></asp:DropDownList>
        ...
        <asp:Repeater ID="rpt_TruckTeam" runat="server" OnItemCommand="rpt_TruckTeam_ItemCommand">
            <ItemTemplate>
                <tr>
                            <td><%#Eval("TeamID") %></td>
                            <td><%#Eval("TeamName") %></td>
                            ...
                            <td><asp:LinkButton ID="LinkButton1" CommandName="Truck" CommandArgument='<%#Eval("TeamID") %>' CssClass="button orange medium" runat="server">查看车辆</asp:LinkButton></td>
                        </tr>
            </ItemTemplate>
