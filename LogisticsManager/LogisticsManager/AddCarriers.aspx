<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCarriers.aspx.cs" Inherits="LogisticsManager.AddCarriers" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>添加承运单</strong></div>
                    <div style="width: 900px; margin: auto;">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnAdd" runat="server" Text="添加" CssClass=" button orange" OnClick="btnAdd_Click" />
