<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulingManager.aspx.cs" Inherits="LogisticsManager.SchedulingManager" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                    <a href="#">车辆调度</a> <span class="divider">/</span>
                    车辆调度管理
                </ul>
                <form id="form1" runat="server">
                    <div class="title_right"><strong>车辆调度管理</strong></div>
                    <div style="width: 900px; margin: auto;">
                            <table class="bordered">
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt_Carriers" runat="server" OnItemCommand="rpt_Carriers_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lbtnDetails" CommandName="Details" CommandArgument='<%#Eval("CarriersID") %>' CssClass="button orange" runat="server">详情</asp:LinkButton></td>
                                                <td>
                                                    <asp:LinkButton ID="lbtnScheduling" CommandName="CommandTruck" CommandArgument='<%#Eval("CarriersID") %>'  CssClass="button orange" runat="server">车辆调度</asp:LinkButton></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </tbody>
