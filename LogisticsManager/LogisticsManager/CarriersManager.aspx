<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarriersManager.aspx.cs" Inherits="LogisticsManager.CarriersManager" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>承运单维护</strong></div>
                                ...
                                <asp:Repeater ID="rpt_Carriers" runat="server" OnItemCommand="rpt_Carriers_ItemCommand" OnItemDataBound="rpt_Carriers_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#ChangeState(Convert.ToInt32(Eval("FinishedState"))) %></td>
                                            <td>
                                                <asp:LinkButton ID="lbtnDetils" CommandName="Detils" CommandArgument='<%#Eval("CarriersID") %>' CssClass="button orange medium" runat="server">详情</asp:LinkButton></td>
                                            <td>
                                                <asp:LinkButton ID="lbtnAdd" CommandName="AddGoods" CommandArgument='<%#Eval("CarriersID") %>' CssClass="button orange medium" runat="server">添加货物</asp:LinkButton>
                                                <asp:LinkButton ID="lbtnUpdate" CommandName="Update" CommandArgument='<%#Eval("CarriersID") %>' CssClass="button orange medium" runat="server">修改</asp:LinkButton>
                                                <asp:LinkButton ID="lbtnDelete" CommandName="delete" CommandArgument='<%#Eval("CarriersID") %>' OnClientClick='confirm("您确定要删除吗？")' CssClass="button red medium" runat="server">删除</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
