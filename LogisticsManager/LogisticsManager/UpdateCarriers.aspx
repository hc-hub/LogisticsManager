<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCarriers.aspx.cs" Inherits="LogisticsManager.UpdateCarriers" %>
...
<body>
  ...
  <a href="#">首页</a> <span class="divider">/</span>
                ...
                <form id="form1" runat="server">
                    <div class="title_right"><strong>修改承运单</strong></div>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>收货单位地址:</td>
                                <td>
                                    <asp:TextBox ID="txtReceiveAddress" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                <td>发货人:</td>
                                <td>
                                    <asp:TextBox ID="txtSendLinkman" runat="server"></asp:TextBox></td>
                                <td>收货人:</td>
                                <td>
                                    <asp:TextBox ID="txtReceiveLinkman" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>发货人电话:</td>
                                <td>
                                    <asp:TextBox ID="txtSendPhone" runat="server"></asp:TextBox></td>
                                <td>收货人电话:</td>
                                <td>
                                    <asp:TextBox ID="txtReceivePhone" runat="server"></asp:TextBox></td>
                                   </tr>
                            <tr>
                                <td>保险费:</td>
                                <td>
                                    <asp:TextBox ID="txtInsuranceCost" runat="server"></asp:TextBox></td>
                                <td>运费:</td>
                                <td>
                                    <asp:TextBox ID="txtTransportCost" runat="server"></asp:TextBox></td>
                                   </tr>
                            <tr>
                                <td>其他费用:</td>
                                <td>
                                  ...
                                  <td>  <asp:Button ID="btnUpdate" runat="server" Text="修改" CssClass="button orange" OnClick="btnUpdate_Click" />
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    <hr />
                                    <asp:Button ID="btnResult" runat="server" CssClass="button gray" Text="返回" OnClick="btnResult_Click" />
                                </td>
